...
const giftVouchers: LoveVoucher[] = [
  ...
  },
  {
    ...
    description: "Un masaje relajante de 60 minutos para eliminar todo tu estrés",
    validUntil: "31/12/2024",
    icon: "💆‍♀️"
  },
  {
              ...
              <div className="space-y-6">
                {giftVouchers.map((voucher, index) => (
                  <motion.div
                    ...
                    className="relative bg-gradient-to-r from-pink-50 to-red-50 rounded-lg overflow-hidden"
                  >
                    {/* Ticket Border */}
