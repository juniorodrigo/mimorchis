    ...
    >
      ...
      >
        <div className="text-center">
          <p className="text-lg font-baloo text-gray-600 mb-2">
            Desliza aquí para descubrir algo especial...
          </p>
          <AnimatePresence>
            {isHovered && (
              <motion.div
              ...
              >
                <p className="text-xl font-baloo text-red-600 p-6">
                  {currentMessage}
                </p>
              </motion.div>
            )}
